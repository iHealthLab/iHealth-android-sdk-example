...
public class HS2 extends FunctionFoldActivity {
    ...
    @OnClick({R.id.btnDisconnect, R.id.btnMeasurement, R.id.btnBattery,
...
//                UpgradeControl.getInstance().queryDeviceFirmwareInfo(mDeviceMac, iHealthDevicesManager.TYPE_HS2);
